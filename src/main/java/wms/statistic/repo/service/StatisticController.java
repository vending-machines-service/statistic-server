...
public class StatisticController {
	...
	public Integer etMachineAvgProfit(@PathVariable("machine_id") int machineId, @RequestParam(name = "from", defaultValue = ApiConstants.GET_START_DAY) String from,
			@RequestParam(name = "to", defaultValue = "now") String to){
		if(to.equals("now")) {
	...
	@GetMapping(ApiConstants.GET_PRODUCT_INCOME + "/{product_id}")
	public Integer getProductIncomeByPeriod(@PathVariable("product_id") int productId, @RequestParam(name = "from", defaultValue = ApiConstants.GET_START_DAY) String from,
			@RequestParam(name = "to", defaultValue = "now") String to){
		if(to.equals("now")) {
			return service.getProductIncomeByPeriod(productId,LocalDate.parse(from, format), LocalDate.now());
		}
		return service.getProductIncomeByPeriod(productId,LocalDate.parse(from, format), LocalDate.parse(to, format));
	}
	
	@GetMapping(ApiConstants.GET_MOST_PROFIT_PRODUCT)
	public List<ProductDTO> getMostProfitableProductsByPeriod(@RequestParam(name = "from", defaultValue = ApiConstants.GET_START_DAY) String from,
			@RequestParam(name = "to", defaultValue = "now") String to) {
		DateTimeFormatter format = DateTimeFormatter.ofPattern("yyyy-MM-dd");
		if(to.equals("now")) {
	...
	public List<ProductDTO> getLessProfitableProductssByPeriod(@RequestParam(name = "from", defaultValue = ApiConstants.GET_START_DAY) String from,
			@RequestParam(name = "to", defaultValue = "now") String to) {
		if(to.equals("now")) {
	...
	public List<ProductDTO> getMostSellCountProductsByPeriod(@RequestParam(name = "from", defaultValue = ApiConstants.GET_START_DAY) String from,
			@RequestParam(name = "to", defaultValue = "now") String to) {
		if(to.equals("now")) {
	...
	public List<ProductDTO> getLesstSellCountProductsByPeriod(@RequestParam(name = "from", defaultValue = ApiConstants.GET_START_DAY) String from,
			@RequestParam(name = "to", defaultValue = "now") String to) {
		if(to.equals("now")) {
	...
	public Integer getProductSellCountPeriod(@PathVariable("product_name") String productName, @RequestParam(name = "from", defaultValue = ApiConstants.GET_START_DAY) String from,
			@RequestParam(name = "to", defaultValue = "now") String to){
		if(to.equals("now")) {
	...
	public Map<Integer, Integer> getPeriodAvgYearProfit(@RequestParam(name = "fromYear", defaultValue = ApiConstants.GET_START_YEAR) 
		String fromYear, @RequestParam(name = "toYear", defaultValue = "now") String toYear ) {
	...
	public Map<Integer, Integer> getYearMachineProfitByPeriod(@PathVariable("machine_id") int machineId, @RequestParam(name = "fromYear", defaultValue = ApiConstants.GET_START_YEAR) 
		String fromYear, @RequestParam(name = "toYear", defaultValue = "now") String toYear ) {
	if(toYear.equals("now")) {
